...
<div class="row mt-2">
    ...
    <?php // echo $form->field($model, 'cus_type_id') ?>

    <?php // echo $form->field($model, 'cus_group_id') ?>

    <?php // echo $form->field($model, 'tax1_id') ?>

    <?php // echo $form->field($model, 'tax2_id') ?>

    <?php // echo $form->field($model, 'tax1_exemption_no') ?>

    <?php // echo $form->field($model, 'tax2_exemption_no') ?>

    <?php // echo $form->field($model, 'tax_no') ?>

    <?php // echo $form->field($model, 'currency_id') ?>

    <?php // echo $form->field($model, 'credit_limit_enabled') ?>

    <?php // echo $form->field($model, 'credit_limit_amount') ?>

    <?php // echo $form->field($model, 'credit_limit_restriction') ?>
    ...
    <?php // echo $form->field($model, 'allow_backorders') ?>

    <?php // echo $form->field($model, 'salesman_id') ?>

    <?php // echo $form->field($model, 'shipment_contact_seq') ?>
