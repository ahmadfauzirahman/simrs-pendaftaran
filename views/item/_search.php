...
<div class="row mt-2">
    ...
    <?= $form->field($model, 'item_english') ?>

    <?= $form->field($model, 'item_type_id') ?>

    <?php // echo $form->field($model, 'item_group_id') ?>
    ...
    <?php // echo $form->field($model, 'fixed_cost_pct') ?>
    ...
    <?php // echo $form->field($model, 'pharm_formula_editable') ?>
    ...
    <?php // echo $form->field($model, 'ac_occurence') ?>
    ...
    <?php // echo $form->field($model, 'max_purchase_price') ?>

    <?php // echo $form->field($model, 'max_nett_purchase_price') ?>
    ...
    <?php // echo $form->field($model, 'kategori6') ?>
