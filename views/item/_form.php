...
<div class="item-form">
    ...
    <?= $form->field($model, 'item_english')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'fixed_cost_pct')->textInput() ?>
    ...
    <?= $form->field($model, 'pharm_formula_editable')->textInput() ?>
    ...
    <?= $form->field($model, 'ac_occurence')->textInput() ?>
    ...
    <?= $form->field($model, 'max_purchase_price')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'max_nett_purchase_price')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'kategori6')->textInput(['maxlength' => true]) ?>
