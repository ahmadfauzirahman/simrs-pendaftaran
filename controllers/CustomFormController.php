...
use app\models\CustomFormSearch;
...
class CustomFormController extends Controller
{
    ...
    /**
     * Displays a single CustomForm model.
     * @param integer $id
     * @return mixed
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->custom_form_id]);
        }
    ...
    /**
     * Deletes an existing CustomForm model.
