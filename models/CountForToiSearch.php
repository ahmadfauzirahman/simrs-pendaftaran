...
/**
 * CountForToiSearch represents the model behind the search form of `app\models\CountForToi`.
 */
class CountForToiSearch extends CountForToi
{
    /**
     * {@inheritdoc}
     */
