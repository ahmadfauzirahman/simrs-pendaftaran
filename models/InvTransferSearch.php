...
/**
 * InvTransferSearch represents the model behind the search form of `app\models\InvTransfer`.
 */
class InvTransferSearch extends InvTransfer
{
    /**
     * {@inheritdoc}
     */
