...
/**
 * NumActvMntnSearch represents the model behind the search form of `app\models\NumActvMntn`.
 */
class NumActvMntnSearch extends NumActvMntn
{
    /**
     * {@inheritdoc}
     */
