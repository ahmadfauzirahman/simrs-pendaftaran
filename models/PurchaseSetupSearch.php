...
/**
 * PurchaseSetupSearch represents the model behind the search form of `app\models\PurchaseSetup`.
 */
class PurchaseSetupSearch extends PurchaseSetup
{
    /**
     * {@inheritdoc}
     */
