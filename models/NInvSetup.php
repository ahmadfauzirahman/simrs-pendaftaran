...
/**
 * This is the model class for table "n_inv_setup".
 *
 ...
 *
 * @property NInvAdjAccount $countAdjustInAcc
 * @property NInvAdjAccount $countAdjustOutAcc
 ...
 */
class NInvSetup extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['company_id'], 'unique'],
            [['count_adjust_in_acc_id'], 'exist', 'skipOnError' => true, 'targetClass' => NInvAdjAccount::className(), 'targetAttribute' => ['count_adjust_in_acc_id' => 'account_id']],
            [['count_adjust_out_acc_id'], 'exist', 'skipOnError' => true, 'targetClass' => NInvAdjAccount::className(), 'targetAttribute' => ['count_adjust_out_acc_id' => 'account_id']],
    ...
    {
        return $this->hasOne(NInvAdjAccount::className(), ['account_id' => 'count_adjust_in_acc_id']);
    }
    ...
    {
        return $this->hasOne(NInvAdjAccount::className(), ['account_id' => 'count_adjust_out_acc_id']);
    }
