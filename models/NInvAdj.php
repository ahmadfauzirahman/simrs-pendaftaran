...
/**
 * This is the model class for table "n_inv_adj".
 *
 ...
 * @property NInvAdjAccount $adjAccount
 * @property ScrtUser $createdUser
 * @property ScrtUser $modifiedUser
 * @property NInvAdjDet[] $nInvAdjDets
 */
class NInvAdj extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['adj_account_id'], 'exist', 'skipOnError' => true, 'targetClass' => NInvAdjAccount::className(), 'targetAttribute' => ['adj_account_id' => 'account_id']],
    ...
    {
        return $this->hasOne(NInvAdjAccount::className(), ['account_id' => 'adj_account_id']);
    }
    ...
    {
        return $this->hasMany(NInvAdjDet::className(), ['adjustment_id' => 'adjustment_id']);
    }
}
