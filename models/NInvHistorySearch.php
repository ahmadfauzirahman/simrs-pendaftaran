...
/**
 * NInvHistorySearch represents the model behind the search form of `app\models\NInvHistory`.
 */
class NInvHistorySearch extends NInvHistory
{
    /**
     * {@inheritdoc}
     */
