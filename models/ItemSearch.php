...
class ItemSearch extends Item
{
    ...
    public function rules()
    {
        return [
            ...
            [['item_no', 'item_name', 'item_english', 'created_time', 'modified_time', 'notes', 'lab_exam_mtd', 'ac_evaluate_time', 'manufacturer', 'formula', 'warna', 'sediaan', 'gol_ims', 'subgol_ims', 'kel_therapi', 'carapakai', 'kategori1', 'kategori2', 'kategori3', 'kategori4', 'kategori5', 'kategori6', 'photo', 'item_name_en', 'kategori1_en', 'kategori2_en', 'kategori3_en', 'kategori4_en', 'kategori5_en'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'fixed_cost_pct' => $this->fixed_cost_pct,
            ...
            'pharm_formula_editable' => $this->pharm_formula_editable,
            ...
            'ac_occurence' => $this->ac_occurence,
            ...
            'max_nett_purchase_price' => $this->max_nett_purchase_price,
            'kategori_dokter' => $this->kategori_dokter,
        ]);

        $query->andFilterWhere(['like', 'item_no', $this->item_no])
            ->andFilterWhere(['like', 'item_name', $this->item_name])
            ->andFilterWhere(['like', 'item_english', $this->item_english])
            ...
            ->andFilterWhere(['like', 'kategori6', $this->kategori6])
