...
use app\models\NItem;

/**
 * NItemSearch represents the model behind the search form of `app\models\NItem`.
 */
class NItemSearch extends NItem
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['item_no', 'item_name', 'created_time', 'modified_time', 'notes', 'lab_exam_mtd', 'ac_evaluate_time', 'manufacturer', 'formula', 'warna', 'sediaan', 'gol_ims', 'subgol_ims', 'kel_therapi', 'carapakai', 'kategori1', 'kategori2', 'kategori3', 'kategori4', 'kategori5', 'photo'], 'safe'],
