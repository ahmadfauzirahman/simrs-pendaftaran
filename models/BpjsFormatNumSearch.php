...
/**
 * BpjsFormatNumSearch represents the model behind the search form of `app\models\BpjsFormatNum`.
 */
class BpjsFormatNumSearch extends BpjsFormatNum
{
    /**
     * {@inheritdoc}
     */
