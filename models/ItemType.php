 ...
 * @property int|null $costing_journal
 * @property string|null $item_category
 * @property string|null $item_category_en
 *
 * @property Item[] $items
...
class ItemType extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['inventory', 'costing_method', 'created_user_id', 'modified_user_id', 'sales_gl_acc_id', 'sales_disc_gl_acc_id', 'inventory_gl_acc_id', 'cogs_gl_acc_id', 'cat', 'sales_ret_gl_acc_id', 'costing_journal'], 'integer'],
            [['created_time', 'modified_time'], 'safe'],
            [['type_name', 'item_category', 'item_category_en'], 'string', 'max' => 50],
            [['type_name'], 'unique'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'costing_journal' => 'Costing Journal',
            'item_category' => 'Item Category',
            'item_category_en' => 'Item Category En',
        ];
    }
    ...
    {
        return $this->hasMany(StaffDet::className(), ['item_type_id' => 'item_type_id']);
    }
}
