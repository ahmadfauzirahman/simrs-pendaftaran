...
/**
 * PreceiptDetSearch represents the model behind the search form of `app\models\PreceiptDet`.
 */
class PreceiptDetSearch extends PreceiptDet
{
    /**
     * {@inheritdoc}
     */
