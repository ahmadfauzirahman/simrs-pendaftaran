...
/**
 * This is the model class for table "n_inv_count".
 *
 ...
 *
 * @property NInvAdjAccount $adjustInAcc
 * @property NInvAdjAccount $adjustOutAcc
 * @property ScrtUser $createdUser
 * @property ScrtUser $modifiedUser
 * @property NWarehouse $warehouse
 * @property NInvCountDet[] $nInvCountDets
 */
class NInvCount extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['count_id'], 'unique'],
            [['adjust_in_acc_id'], 'exist', 'skipOnError' => true, 'targetClass' => NInvAdjAccount::className(), 'targetAttribute' => ['adjust_in_acc_id' => 'account_id']],
            [['adjust_out_acc_id'], 'exist', 'skipOnError' => true, 'targetClass' => NInvAdjAccount::className(), 'targetAttribute' => ['adjust_out_acc_id' => 'account_id']],
    ...
    {
        return $this->hasOne(NInvAdjAccount::className(), ['account_id' => 'adjust_in_acc_id']);
    }
    ...
    {
        return $this->hasOne(NInvAdjAccount::className(), ['account_id' => 'adjust_out_acc_id']);
    }
    ...
    {
        return $this->hasMany(NInvCountDet::className(), ['count_id' => 'count_id']);
    }
}
