...
/**
 * This is the model class for table "n_porder".
 *
 ...
 */
class NPorder extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            [['order_id'], 'required'],
            [['order_id', 'vendor_id', 'carrier_id', 'warehouse_id', 'order_status', 'printed', 'currency_id', 'category_id', 'tax1_id', 'tax2_id', 'taxable_tax1_id', 'taxable_tax2_id', 'taxable_tax3_id', 'shipto', 'num_of_receipts', 'created_user_id', 'modified_user_id', 'ap_invoice_id', 'items_received', 'paid', 'bank_id', 'request_id'], 'integer'],
            [['order_date', 'req_received_date', 'created_time', 'modified_time'], 'safe'],
            ...
            [['order_no', 'received_by', 'ap_invoice_no', 'request_no'], 'string', 'max' => 20],
    ...
    {
        return $this->hasMany(NPorderDet::className(), ['order_id' => 'order_id']);
    }
    ...
    {
        return $this->hasMany(NPreceipt::className(), ['order_id' => 'order_id']);
    }
}
