...
/**
 * ArInvDetSearch represents the model behind the search form of `app\models\ArInvDet`.
 */
class ArInvDetSearch extends ArInvDet
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['uom', 'remark', 'ship_from', 'ship_until'], 'safe'],
        ];
    }
