...
/**
 * NumFeeAmbulanceSearch represents the model behind the search form of `app\models\NumFeeAmbulance`.
 */
class NumFeeAmbulanceSearch extends NumFeeAmbulance
{
    /**
     * {@inheritdoc}
     */
