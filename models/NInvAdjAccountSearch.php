...
/**
 * NInvAdjAccountSearch represents the model behind the search form of `app\models\NInvAdjAccount`.
 */
class NInvAdjAccountSearch extends NInvAdjAccount
{
    /**
     * {@inheritdoc}
     */
