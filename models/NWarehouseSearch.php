...
/**
 * NWarehouseSearch represents the model behind the search form of `app\models\NWarehouse`.
 */
class NWarehouseSearch extends NWarehouse
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['warehouse_id', 'sales_item', 'purchase_item', 'created_user_id', 'modified_user_id'], 'integer'],
