...
/**
 * This is the model class for table "n_preceipt".
 *
 ...
 */
class NPreceipt extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(NPreceiptDet::className(), ['receipt_id' => 'receipt_id']);
    }
}
