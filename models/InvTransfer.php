...
/**
 * This is the model class for table "inv_transfer".
 *
 ...
 *
 * @property Warehouse $sourceWh
 * @property Warehouse $destinationWh
 * @property ScrtUser $createdUser
 * @property ScrtUser $modifiedUser
 * @property InvTransferDet[] $invTransferDets
 */
class InvTransfer extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['transfer_id'], 'unique'],
            [['source_wh_id'], 'exist', 'skipOnError' => true, 'targetClass' => Warehouse::className(), 'targetAttribute' => ['source_wh_id' => 'warehouse_id']],
            [['destination_wh_id'], 'exist', 'skipOnError' => true, 'targetClass' => Warehouse::className(), 'targetAttribute' => ['destination_wh_id' => 'warehouse_id']],
    ...
    {
        return $this->hasOne(Warehouse::className(), ['warehouse_id' => 'source_wh_id']);
    }
    ...
    {
        return $this->hasOne(Warehouse::className(), ['warehouse_id' => 'destination_wh_id']);
    }
    ...
    {
        return $this->hasMany(InvTransferDet::className(), ['transfer_id' => 'transfer_id']);
    }
}
