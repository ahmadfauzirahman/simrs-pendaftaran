...
/**
 * MaintSeveritySearch represents the model behind the search form of `app\models\MaintSeverity`.
 */
class MaintSeveritySearch extends MaintSeverity
{
    /**
     * {@inheritdoc}
     */
