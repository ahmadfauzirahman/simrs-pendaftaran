...
/**
 * NPorderSearch represents the model behind the search form of `app\models\NPorder`.
 */
class NPorderSearch extends NPorder
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['order_no', 'order_date', 'req_received_date', 'term_payment', 'ordered_by', 'shipto_name', 'shipto_address', 'notes', 'created_time', 'modified_time', 'received_by', 'ap_invoice_no', 'request_no'], 'safe'],
