...
/**
 * FolioTherapyMtlSearch represents the model behind the search form of `app\models\FolioTherapyMtl`.
 */
class FolioTherapyMtlSearch extends FolioTherapyMtl
{
    /**
     * {@inheritdoc}
     */
