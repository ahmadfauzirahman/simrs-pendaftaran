...
/**
 * ApInvBindSearch represents the model behind the search form of `app\models\ApInvBind`.
 */
class ApInvBindSearch extends ApInvBind
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['bind_no', 'bind_date', 'vendor_reference', 'return_date', 'notes', 'created_time', 'modified_time'], 'safe'],
        ];
    }
